...
cap.style.color = "red";
getDatasecond().then(); // const load = async () => {
...
},{"./api/get":"daUFG"}],"daUFG":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getData", ()=>getData);
const API_KEY = "55316744-d36208193e3c53252b47581ad";
const getData = async (page = 1)=>{
    const result = await fetch(`https://pixabay.com/api/?key=${API_KEY}&q=cat&lang=ru&page=${page}&per_page=3`);
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire9add", {})

//# sourceMappingURL=pix.0f77c784.js.map
